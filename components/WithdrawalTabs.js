'use client'; // यह लाइन ही सारे बटन क्लिक और फंक्शन को चलाएगी
...
// मुख्य कंपोनेंट जो पूरा टैब सिस्टम हैंडल करता है
const WithdrawalTabs = () => {
  // यह स्टेट activeTab को ट्रैक करता है, ताकि पता चले कौनसा टैब दिखाना है
    ...
    <div className="w-full">
      ...
      <div role="tablist" className="h-10 items-center justify-center rounded-md p-1 text-muted-foreground grid w-full grid-cols-2 bg-black/50 border border-slate-700">
        <button 
          ...
          className="justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium transition-all flex items-center text-slate-100 gap-2 data-[state=active]:bg-purple-600 data-[state=active]:text-white data-[state=active]:shadow-sm"
        >
        ...
        <button 
          ...
          className="justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium transition-all flex text-slate-100 items-center gap-2 data-[state=active]:bg-purple-600 data-[state=active]:text-white data-[state=active]:shadow-sm"
        >
          <WalletIcon /> Transfer
        </button>
      </div>

      {/* यह टैब का कंटेंट है, जो activeTab के आधार पर बदलता है */}
      <div className="mt-6">
        {/* अगर activeTab 'locked' है, तो यह हिस्सा दिखेगा */}
        {activeTab === 'locked' && (
        ...
        {/* अगर activeTab 'transfer' है, तो यह हिस्सा दिखेगा */}
        {activeTab === 'transfer' && (
          <div className="rounded-lg border text-card-foreground shadow-sm bg-black/50 border-slate-700 backdrop-blur p-6">
